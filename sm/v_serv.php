    ...
    <div class="wrapper">
        <div class="container h-10 ">
            <div class=" mt-4 text-center col-12">
              ...
              <h3>  Depot : <?php echo $_SESSION['name']; ?> </h3> 
            </div>
                    ...
                    <div class="container-fluid mh-50">
                        ...
                        <?php
                                ...
                                if($_SERVER["REQUEST_METHOD"] == "POST")
                                {
                                    ...
                                    $query2 ="select * from bus_services JOIN bus_routes on bus_routes.route_id = bus_services.route_id where bus_services.route_id in (SELECT BR.route_id FROM bus_routes BR JOIN route_stops RS1 ON BR.route_id = RS1.route_id JOIN route_stops RS2 ON BR.route_id = RS2.route_id WHERE RS1.stop_id = ".$_SESSION['st']." AND RS2.stop_id =".$stnn." AND RS2.stop_order >= RS1.stop_order) " ;
                                    
                                    
                                } else {
                                    $query2 = "SELECT * FROM `bus_services`JOIN route_stops on route_stops.route_id = bus_services.route_id  JOIN bus_routes on bus_routes.route_id = bus_services.route_id where route_stops.stop_id = ". $_SESSION['st'] ;
                                    ...
                                    if (mysqli_num_rows($result) > 0) { ?>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {   ?>
                                          ...
                                          <td ><?php echo $row['e_time']; ?></td>
                                           <td class="text-center dropdown"><button type="button" class="btn btn-primary text-light"><a class="text-light"href="ad_sts.php?id=<?php echo $row['serv_id']; ?>">Edit</a></button></td>
